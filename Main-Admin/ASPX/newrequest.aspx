<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newrequest.aspx.cs" Inherits="club_final.newrequest" %>
    ...
    <div class="container-fluid ">
		<div class="row">		
			...
			<div class="col-sm-9 col-sm-push-3 contentAreaStyle" style="height:600px;text-align:left">
			    ...
			    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:clubConnectionString15 %>" SelectCommand="SELECT [id], [clubName] FROM [ClubRegister] WHERE (([stas] = @stas) AND ([typeofclub] = @typeofclub)) ORDER BY [id]">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="1" Name="stas" Type="Byte" />
                        <asp:SessionParameter Name="typeofclub" SessionField="member" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
